        ...
        then 
            ...
            g   [ Style [ 
                ...
                [
                    ...
                    let printableS = stringLst |> List.fold (fun y x -> y + x + "\n") ""
                    text [ 
                        X 20.; 
                        Y 70.; 
                        Style [
...
let view (model : Model) (dispatch : Msg -> unit) =    
    [   // change for Tick3 answer
        makeBusDecoderComponent {X=70.; Y=20.} 69 7 5// for Tick 3 two components
        makeBusDecoderComponent {X=200.; Y=20.} 69 7 8
    ] 
